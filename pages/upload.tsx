        ...
        <div className='bg-white rounded-lg lg:h-[80vh] flex-wrap flex gap-6 items-center p-14 pt-6 w-[60%] justify-between '>
            <div>
                <div>
                    ...
                    <p className='text-md text-gray-400 mt-1'>Post</p>
                </div>
                <div className='border-dashed rounded-xl border-4 border-gray-200 flex flex-col items-center justify-center outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:border-blue-300 hover:bg-gray-100 transition ease delay-150 hover:-translate-y-1 '>
                    {isLoading ? (
                        <p>Uploading....</p>
                    ):(
                        <div>
                            {videoAsset ? (
                                ...
                                <label className='cursor-pointer'>
                                    <div className='flex flex-col items-center justify-center h-full'>
                                        ...
                                        <p className='bg-pink-200 text-center mt-10 rounded text-white text-md font-medium p-2 w-52 outline-none'>
                                            Select File
                                        </p>
                                    </div>
                                    <input 
