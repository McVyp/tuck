    ...
    <div className='flex flex-col border-b-2 border-gray-200 pb-6'>
        <div className='flex gap-3 p-2 cursor-pointer font-semibold rounded'>
            <div className='md:w-16 md:h-16 w-10 h-10'>
                <Link href={""}>
                    {/* add <></> while putting images inside Link if error occurs */}
                    <Image 
                        height={62}
                        width={62}
            ...
            <div>
                <Link href={""}>
                    <div className='flex items-center gap-2'>
                        <p className='flex items-center md:text-md font-bold text-primary'>{post.postedBy.userName} {` `} <GoVerified  className='text-blue-400 text-md'/></p>
